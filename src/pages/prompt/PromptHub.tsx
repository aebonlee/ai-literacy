      ...
      <GuidePage
        ...
        sidebarFooter={
          <>
            ...
            <Link to="/prompt/test" className="guide-sidebar-cta practice">
        ...
        ctaBanner={
          <>
            <div className="prompt-practice-cta">
              ...
              <Link to="/prompt/workshop" className="prompt-practice-cta-btn">
                <i className="fa-solid fa-wand-magic-sparkles" />
                {isKo ? '작성 평가 시작' : 'Start Workshop'}
              </Link>
            </div>
            <div className="prompt-practice-cta" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.08), rgba(59,130,246,0.02))', borderColor: 'rgba(59,130,246,0.2)' }}>
              <div className="prompt-practice-cta-text">
              ...
              <Link to="/prompt/test" className="prompt-practice-cta-btn" style={{ background: '#1E3A8A' }}>
                <i className="fa-solid fa-clipboard-check" />
