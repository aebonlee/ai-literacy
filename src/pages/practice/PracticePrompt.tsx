    ...
    <>
      ...
      <section className="practice-detail">
        <div className="container practice-content">
          {/* 프롬프트 패턴 */}
          <h3>
            <i className="fa-solid fa-puzzle-piece" style={{ color: '#7C3AED', marginRight: '0.5rem' }}></i>
            프롬프트 패턴
          </h3>
          <p>
          ...
          <div className="flow-diagram">
            <div className="flow-step">
              <span className="flow-icon"><i className="fa-solid fa-user-tie"></i></span>
              <span className="flow-label">역할 부여</span>
              <span className="flow-desc">전문가 역할</span>
            </div>
            <span className="flow-arrow"><i className="fa-solid fa-arrow-right"></i></span>
            <div className="flow-step">
              <span className="flow-icon"><i className="fa-solid fa-file-lines"></i></span>
              <span className="flow-label">맥락 제공</span>
              <span className="flow-desc">배경 정보</span>
            </div>
            <span className="flow-arrow"><i className="fa-solid fa-arrow-right"></i></span>
            <div className="flow-step">
              <span className="flow-icon"><i className="fa-solid fa-bullseye"></i></span>
              <span className="flow-label">목표 명시</span>
              <span className="flow-desc">구체적 요청</span>
            </div>
            <span className="flow-arrow"><i className="fa-solid fa-arrow-right"></i></span>
            <div className="flow-step">
              <span className="flow-icon"><i className="fa-solid fa-table-columns"></i></span>
              <span className="flow-label">형식 지정</span>
              <span className="flow-desc">출력 포맷</span>
            </div>
            <span className="flow-arrow"><i className="fa-solid fa-arrow-right"></i></span>
            <div className="flow-step">
              <span className="flow-icon"><i className="fa-solid fa-sliders"></i></span>
          ...
          {/* 실전 예시 */}
          <h3>
            <i className="fa-solid fa-pen-nib" style={{ color: '#059669', marginRight: '0.5rem' }}></i>
            실전 예시
          </h3>
          ...
          {/* 연습 문제 */}
          <h3>
            <i className="fa-solid fa-clipboard-check" style={{ color: '#DC2626', marginRight: '0.5rem' }}></i>
            연습 문제
          </h3>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border-color, #e5e7eb)' }}>
            <Link to="/practice/gemini" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '0.9rem' }}>
              <i className="fa-solid fa-arrow-left"></i> Gemini 실습
            </Link>
            <Link to="/practice" style={{ color: '#3B82F6', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 600 }}>
              AI 실습 목록 <i className="fa-solid fa-arrow-right"></i>
            </Link>
          </div>
        </div>
      </section>
