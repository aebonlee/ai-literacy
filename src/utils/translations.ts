export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    footer: {
      tagline: 'AI 시대, 누구나 갖춰야 할 AI 리터러시를 학습합니다',
      companyInfo: '회사 정보',
      contact: '연락처',
      quickLinks: '바로가기'
    },
    ...
    site: {
      nav: {
        ...
        ch9: 'Ch.9 AI 안전과 신뢰성',
        ch10: 'Ch.10 데이터 리터러시',
        ch11: 'Ch.11 직장과 일상의 AI',
        ch12: 'Ch.12 AI의 미래와 사회',
        practice: 'AI 실습',
        practiceChatGPT: 'ChatGPT 활용',
        practiceClaude: 'Claude 활용',
        practiceGemini: 'Gemini 활용',
        practicePrompt: '프롬프트 엔지니어링',
        community: '커뮤니티',
        notice: '공지사항',
        qna: 'Q&A',
        myLearning: '나의학습',
      ...
      home: {
        badge: 'AI 시대 필수 교양',
        title: 'AI Literacy',
        subtitle: 'AI를 이해하고 활용하는 힘',
        welcome: 'AI 리터러시 학습 플랫폼에 오신 것을 환영합니다.',
        description: 'AI 기초부터 윤리, 프롬프트 엔지니어링, 미래 전망까지 — 4개 파트, 12개 챕터의 체계적 학습',
        instructor: '이애본 교수',
      }
    }
  },
  ...
  en: {
    ...
    footer: {
      tagline: 'Building essential AI literacy for the AI era',
    ...
    // ─── AI Literacy site-specific keys ───
    site: {
      nav: {
        curriculum: 'Overview',
        overview: 'Overview',
        ...
        part4: 'AI Future',
        ch1: 'Ch.1 What is AI?',
        ch2: 'Ch.2 ML & Deep Learning',
        ch3: 'Ch.3 History of AI',
        ch4: 'Ch.4 Generative AI Tools',
        ch5: 'Ch.5 Prompt Engineering',
        ch6: 'Ch.6 AI Hands-on',
        ch7: 'Ch.7 AI Ethics',
        ch8: 'Ch.8 Bias & Fairness',
        ch9: 'Ch.9 AI Safety & Trust',
        ch10: 'Ch.10 Data Literacy',
        ch11: 'Ch.11 AI in Work & Life',
        ch12: 'Ch.12 AI Future & Society',
        practice: 'AI Lab',
        practiceChatGPT: 'ChatGPT',
        practiceClaude: 'Claude',
        practiceGemini: 'Gemini',
        practicePrompt: 'Prompt Engineering',
        community: 'Community',
        notice: 'Notices',
        qna: 'Q&A',
      ...
      home: {
        badge: 'Essential AI Education',
        title: 'AI Literacy',
        subtitle: 'The Power to Understand and Use AI',
        welcome: 'Welcome to the AI Literacy learning platform.',
        description: 'From AI basics to ethics, prompt engineering, and future outlook — 4 parts, 12 chapters of systematic learning',
        instructor: 'Prof. Aebon Lee',
      }
    }
  }
};
